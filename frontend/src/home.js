    ...
    <div className={styles.container}>
      ...
      >
        ...
        <div className={styles.services_section}>
          <h2>OUR SERVICES</h2>
          <p>
            Our COVID-19 Quarantine Camp provides a safe, supportive environment
            for isolation and recovery. With medical care and mental health
            support, we ensure the well-being of each individual while
        ...
        <footer className={styles.footer}>
          <p>
            <strong>Address:</strong> 268 Ly Thuong Kiet |{" "}
            <strong>Phone:</strong> 0937567495
          </p>
        </footer>
      </div>
    </div>
